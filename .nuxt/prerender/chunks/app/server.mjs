import { hasInjectionContext, inject, version, ref, toRef, getCurrentInstance, onServerPrefetch, useSSRContext, watchEffect, watch, unref, defineComponent, computed, h, resolveComponent, withAsyncContext, withCtx, createVNode, createApp, reactive, Suspense, nextTick, Transition, provide, onErrorCaptured, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, mergeProps, defineAsyncComponent, isRef, isShallow, isReactive, toRaw } from 'file:///Users/victorcosta/Documents/DEV/lets-code/lets-code-primisc-nuxt/node_modules/vue/index.mjs';
...
import { getContext, executeAsync } from 'file:///Users/victorcosta/Documents/DEV/lets-code/lets-code-primisc-nuxt/node_modules/unctx/dist/index.mjs';
...
import { createError as createError$1, sanitizeStatusCode, setCookie, getCookie, deleteCookie } from 'file:///Users/victorcosta/Documents/DEV/lets-code/lets-code-primisc-nuxt/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, parseQuery, withTrailingSlash, withoutTrailingSlash, withQuery, joinURL } from 'file:///Users/victorcosta/Documents/DEV/lets-code/lets-code-primisc-nuxt/node_modules/ufo/dist/index.mjs';
...
import Lenis from 'file:///Users/victorcosta/Documents/DEV/lets-code/lets-code-primisc-nuxt/node_modules/@studio-freight/lenis/dist/lenis.modern.mjs';
...
import { composableNames, getActiveHead, createServerHead as createServerHead$1 } from 'file:///Users/victorcosta/Documents/DEV/lets-code/lets-code-primisc-nuxt/node_modules/unhead/dist/index.mjs';
...
import { isRepositoryEndpoint, getRepositoryName, createClient, filter, cookie, asText, asHTML, asLink, asLinkAttrs, asDate, asImageSrc, asImageWidthSrcSet, asImagePixelDensitySrcSet, documentToLinkField, isFilled } from 'file:///Users/victorcosta/Documents/DEV/lets-code/lets-code-primisc-nuxt/node_modules/@prismicio/client/dist/index.js';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/_uid_-ed8ba581.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/blog-e3ffb01d.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-876754ba.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-78f64015.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-52c205a8.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-0a35d044.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
