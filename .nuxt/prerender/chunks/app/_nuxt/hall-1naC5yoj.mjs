...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "hall-fame" }, _attrs))}><div class="hall-fame__holder"><div class="hall-fame__display"><img${ssrRenderAttr("src", $props.postData.img.url)} loading="lazy" alt="" class="hall-fame__display__img"><div class="hall-fame__video"><video${ssrRenderAttr("src", $props.postData.video.url)} loading="lazy" autoplay muted loop playsinline class="hall-fame__video__video"></video></div></div><div class="hall-fame__info"><div class="hall-fame__info__ctn"><a${ssrRenderAttr("href", $props.postData.url)} target="_blank" class="hall-fame__cta"><div class="hall-fame__cta__span">${ssrInterpolate($props.postData.label_button)}</div></a><h1 class="hall-fame__info__h1">${ssrInterpolate($props.postData.title)}</h1></div><ul class="hall-fame__socials"><li><a href="">LinkedIn</a></li><li><a href="">Instagram</a></li></ul></div></div></div>`);
}
...
//# sourceMappingURL=hall-1naC5yoj.mjs.map
